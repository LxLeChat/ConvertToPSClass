#
# Manifeste de module pour le module « ConvertToPSClass »
#
# Généré par : LxLeChat
#
# Généré le : 01/12/2022
#

@{

# Module de script ou fichier de module binaire associé à ce manifeste
RootModule = 'ConvertToPSClass.psm1'
...
GUID = 'a0aa33df-d517-473b-9967-d41ef70515ee'
...
Copyright = '(c) 2022 LxLeChat. Tous droits réservés.'
...
ScriptsToProcess = 'enums.ps1', 'Classes.ps1'
...
FunctionsToExport = @('ConvertTo-PSClass')
